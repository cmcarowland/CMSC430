/*
	...
	listing.cc
	Functions to produce the compilation listing
	including error messages.

	Contains the definition of the Error class and
	the ErrorCategories enum.

	Maintains a queue of errors that are displayed
